...

{
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      iconBouncing: cookies.get('iconBouncing')
  ...
  componentDidMount(){
    ...
    if ( document.getElementById("genderIcon").classList.contains('drop-down') && this.state.iconBouncing == "true"){
  ...
  genderIconClicked = () => {
        ...
        //set cookie. the icon as been press (next time there won't be an animation)
        const { cookies } = this.props;
        cookies.set('iconBouncing', "true" , { path: '/' });
        this.setState({iconBouncing: "true"});
  ...
  disclaimerClicked = () => {
    ...
    this.setState({
      ...
      bodyText: this.state.user === "patient" ? this.state.lang.disclaimer + "\n\n" + this.state.lang.patientDisclaimer + "\n\n" +  this.state.lang.important : this.state.lang.disclaimer + "\n\n" + this.state.lang.providerDisclaimer + "\n\n" + this.state.lang.important,
      buttonText: this.state.lang.config_modal_agree
    });
  }
  aboutClicked = () => {
