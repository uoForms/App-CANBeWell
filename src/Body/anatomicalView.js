        ...
        if (this.props.isTransgender) {
                ...
                return (
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>colon</h3>}><button id="bowelButton" test-id="bowelButton" className="maleBowel"
                                onClick={(button, text, organ) => this.organClicked("colon", this.props.lang.bowel, "MaleBowel")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>eye</h3>}><button id="eyesButton" test-id="eyesButton" className="maleEyes"
                                onClick={(button, text, organ) => this.organClicked("eye", this.props.lang.eyes, "MaleEyes")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>bone</h3>}><button id="boneButton" test-id="boneButton" className="maleBone"
                                onClick={(button, text, organ) => this.organClicked("bone", this.props.lang.bone, "MaleBone")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button id="liverButton" test-id="liverButton" className="maleLiver"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "MaleLiver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button id="lungsButton" test-id="lungsButton" className="maleLungs"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lungs, "MaleLungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button id="pancreasButton" test-id="pancreasButton" className="malePancreas"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "MalePancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button id="stomachButton" test-id="stomachButton" className="maleStomach"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "MaleStomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button id="aortaButton" test-id="aortaButton" className="maleAorta"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "MaleAorta")}></button></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button id="heartButton" test-id="heartButton" className="maleHeart"
                                onClick={(button, text, organ) => this.organClicked("heart", this.props.lang.heart, "MaleHeart")} /></Tooltip>
                            ...
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button id="brainButton" test-id="brainButton" className="brain"
                                    onClick={(button, text, organ) => this.iconClicked("brain", this.props.lang.brain)}>
                                    <img src={brainIcon} alt="brainIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physical exam</h3>}><button id="examButton" test-id="examButton" className="exam"
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>hip</h3>}><button id="fallsButton" test-id="fallsButton" className="falls"
                                    onClick={(button, text, organ) => this.iconClicked("hip", this.props.lang.hip)}>
                                    <img src={fallsIcon} alt="fallsIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>immunization</h3>}><button id="immunizationButton" test-id="immunizationButton" className="immunization"
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Sun</h3>}><button id="sunExposureButton" test-id="sunExposureButton" className="sunExposure" title='Sun'
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physicalActivity</h3>}><button id="phyActivityButton" test-id="phyActivityButton" className="phyActivity"
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button id="maleGenitalia" test-id="genitaliaButton" className="maleGenitalia"
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>covid</h3>}><button id="covidButton" test-id="covidButton" className="covid"
                                    onClick={(button, text, organ) => this.iconClicked("covid", this.props.lang.covid)}>
                                    <img src={covidIcon} alt="covidIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Mental Health</h3>}><button id="brainGearButton" test-id="brainGearButton" className="brainGear"
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Blood Pressure</h3>}><button id="bpButton" test-id="bpButton" className="bp"
                ...
                return (
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>colon</h3>}><button className="femaleBowel" test-id="bowelButton"
                                onClick={(button, text, organ) => this.organClicked("colon", this.props.lang.bowel, "FemaleBowel")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>eye</h3>}><button className="femaleEyes" test-id="eyesButton"
                                onClick={(button, text, organ) => this.organClicked("eye", this.props.lang.eyes, "FemaleEyes")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>bone</h3>}><button className="femaleBone" test-id="boneButton"
                                onClick={(button, text, organ) => this.organClicked("bone", this.props.lang.bone, "FemaleBone")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button className="femaleLiver" test-id="liverButton"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "FemaleLiver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button className="femaleLungs" test-id="lungsButton"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lungs, "FemaleLungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button className="femalePancreas" test-id="pancreasButton"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "FemalePancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button className="femaleStomach" test-id="stomachButton"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "FemaleStomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>breast</h3>}><button className="breast" test-id="breastButton"
                                onClick={(button, text, organ) => this.organClicked("breast", this.props.lang.breast, "FemaleBreast")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button className="femaleAorta" test-id="aortaButton"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "FemaleAorta")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button className="femaleHeart" test-id="heartButton"
                            ...
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button className="brain" test-id="brainButton"
                                    onClick={(button, text) => this.iconClicked("brain", this.props.lang.brain)}>
                                    <img src={brainIcon} alt="brainIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physical exam</h3>}><button className="exam" test-id="examButton"
                                    onClick={(button, text) => this.iconClicked("physical exam", this.props.lang.stethoscope)}>
                                    <img src={examIcon} alt="examIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>hip</h3>}><button className="falls" test-id="fallsButton"
                                    onClick={(button, text) => this.iconClicked("hip", this.props.lang.hip)}><img
                                        src={fallsIcon} alt="fallsIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>immunization</h3>}><button className="immunization" test-id="immunizationButton"
                                    onClick={(button, text) => this.iconClicked("needle in arm", this.props.lang.needle_in_arm)}>
                                    <img src={immunizationIcon} alt="immunizationIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Sun</h3>}><button className="sunExposure" test-id="sunExposureButton"
                                    onClick={(button, text) => this.iconClicked("sun", this.props.lang.sun)}><img
                                        src={sunExposureIcon} alt="sunExposureIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physicalActivity</h3>}><button className="phyActivity" test-id="phyActivityButton"
                                    onClick={(button, text) => this.iconClicked("figure outside body walking", this.props.lang.figure_outside_body_walking)}>
                                    <img src={phyactIcon} alt="physicalActivityIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Genital</h3>}><button id="femaleGenitalian" className="femaleGenitalia"
                                    test-id="genitaliaButton"
                                    onClick={(button, text) => this.iconClicked("genitalia", this.props.lang.genitalia)}>
                                    <img src={FemaleGenital} alt="GenitalF" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>covid</h3>}><button id="covidButton" className="covid" test-id="covidButton"
                                    onClick={(button, text) => this.iconClicked("covid", this.props.lang.covid)}>
                                    <img src={covidIcon} alt="covidIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Mental Health</h3>}><button id="brainGearButton" className="brainGear" test-id="brainGearButton"
                                        onClick={(button, text, organ) => this.iconClicked("braingear", this.props.lang.braingear)}>
                                    <img src={braingear} alt="braingear"/></button></Tooltip>
                                ...
                                <button id="sleepButton" className="sleep" test-id="sleepButton"
                                        onClick={(button, text, organ) => this.iconClicked("sleep", this.props.lang.sleep)}>
                                    <img src={sleepIcon} alt="sleepIcon"/></button>*/}
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Bllod Pressure</h3>}><button id="bpButton" className="bpfemale" test-id="bpButton"
                                        onClick={(button, text, organ) => this.iconClicked("bp", this.props.lang.bp)}>
                                    <img src={bpIcon} alt="bpIcon"/></button></Tooltip>
                ...
                return (
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>colon</h3>}><button id="bowelButton" className="bowel" test-id="bowelButton"
                                onClick={(button, text, organ) => this.organClicked("colon", this.props.lang.bowel, "Bowel")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>eye</h3>}><button id="eyesButton" className="eyes" test-id="eyesButton"
                                onClick={(button, text, organ) => this.organClicked("eye", this.props.lang.eyes, "Eyes")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>bone</h3>}><button id="boneButton" className="bone" test-id="boneButton"
                                onClick={(button, text, organ) => this.organClicked("bone", this.props.lang.bone, "Bone")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button id="liverButton" className="liver" test-id="liverButton"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "Liver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button id="lungsButton" className="lungs" test-id="lungsButton"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lungs, "Lungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button id="pancreasButton" className="pancreas" test-id="pancreasButton"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "Pancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button id="stomachButton" className="stomach" test-id="stomachButton"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "Stomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>breast</h3>}><button className="breast" test-id="breastButton"
                                onClick={(button, text, organ) => this.organClicked("breast/chest", this.props.lang.transbreast, "Breast/Chest")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button id="aortaButton" className="aorta" test-id="aortaButton"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "Aorta")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button id="heartButton" className="heart" test-id="heartButton"
                                onClick={(button, text, oran) => this.organClicked("heart", this.props.lang.heart, "Heart")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button className="genitalia"
                                onClick={(button, text, organ) => this.organClicked("genitalia", this.props.lang.genitalia, "")} /></Tooltip>
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button id="brainButton" className="brain" test-id="brainButton"
                                    onClick={(button, text) => this.iconClicked("brain", this.props.lang.brain)}>
                                    <img src={brainIcon} alt="brainIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physical exam</h3>}><button id="examButton" className="exam" test-id="examButton"
                                    onClick={(button, text) => this.iconClicked("physical exam", this.props.lang.stethoscope)}>
                                    <img src={examIcon} alt="examIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>hip</h3>}><button id="fallsButton" className="falls" test-id="fallsButton"
                                    onClick={(button, text) => this.iconClicked("hip", this.props.lang.hip)}><img
                                        src={fallsIcon} alt="fallsIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>immunization</h3>}><button id="immunizationButton" className="immunization" test-id="immunizationButton"
                                    onClick={(button, text) => this.iconClicked("needle in arm", this.props.lang.needle_in_arm)}>
                                    <img src={immunizationIcon} alt="immunizationIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>sun</h3>}><button id="sunExposureButton" className="sunExposure" test-id="sunExposureButton"
                                    onClick={(button, text) => this.iconClicked("sun", this.props.lang.sun)}><img
                                        src={sunExposureIcon} alt="sunExposureIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physicalActivity</h3>}><button id="phyActivityButton" className="phyActivity" test-id="phyActivityButton"
                                    onClick={(button, text) => this.iconClicked("figure outside body walking", this.props.lang.figure_outside_body_walking)}>
                                    <img src={phyactIcon} alt="physicalActivityIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>covid</h3>}><button id="covidButton" className="covid" test-id="covidButton"
                                    onClick={(button, text) => this.iconClicked("covid", this.props.lang.covid)}><img src={covidIcon} alt="covidIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button id="genitaliaButton" className="transGenital" test-id="genitaliaButton"
                                    onClick={(button, text) => this.iconClicked("genitalia", this.props.lang.genitalia)}>
                                ...
                                <button id="sleepButton" className="sleep" test-id="sleepButton"
                                        onClick={(button, text, organ) => this.iconClicked("sleep", this.props.lang.sleep)}>
                                    <img src={sleepIcon} alt="sleepIcon"/></button>*/}
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Blood Pressure</h3>}><button id="bpButton" className="bpnb" test-id="bpButton"
                                        onClick={(button, text, organ) => this.iconClicked("bp", this.props.lang.bp)}>
                                    <img src={bpIcon} alt="bpIcon"/></button> </Tooltip>
                    ...
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>breast</h3>}><button className="breast" test-id="breastButton"
                                onClick={(button, text, organ) => this.organClicked("breast/chest", this.props.lang.transbreast, "Breast/Chest")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button id="aortaButton" className="aorta" test-id="aortaButton"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "Aorta")}></button></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button id="heartButton" className="heart" test-id="heartButton"
                                onClick={(button, text, oran) => this.organClicked("heart", this.props.lang.heart, "Heart")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button className="genitalia"
                                onClick={(button, text, organ) => this.organClicked("genitalia", this.props.lang.genitalia, "")} /></Tooltip>
                            <div className="icons">
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physical exam</h3>}><button id="examButton" className="exam" test-id="examButton"
                                    onClick={(button, text) => this.iconClicked("physical exam", this.props.lang.stethoscope)}>
                                    <img src={examIcon} alt="examIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>falls</h3>}><button id="fallsButton" className="falls" test-id="fallsButton"
                                    onClick={(button, text) => this.iconClicked("hip", this.props.lang.hip)}><img
                                        src={fallsIcon} alt="fallsIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>immunization</h3>}><button id="immunizationButton" className="immunization" test-id="immunizationButton"
                                    onClick={(button, text) => this.iconClicked("needle in arm", this.props.lang.needle_in_arm)}>
                                ...
                                <button id="sleepButton" className="sleep" test-id="sleepButton"
                                        onClick={(button, text, organ) => this.iconClicked("sleep", this.props.lang.sleep)}>
                                    <img src={sleepIcon} alt="sleepIcon"/></button>*/}
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Blood Pressure</h3>}><button id="bpButton" className="bptg" test-id="bpButton"
                                        onClick={(button, text, organ) => this.iconClicked("bp", this.props.lang.bp)}>
                                    <img src={bpIcon} alt="bpIcon"/></button> </Tooltip>
                                {/*<button id="transButton" className="trans" onClick={(button, text) => this.iconClicked("trans", this.props.lang.covid)}><img src={transIcon} alt="transIcon" /></button>*/}
                ...
                return (
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>colon</h3>}><button id="bowelButton" className="bowel"
                                onClick={(button, text, organ) => this.organClicked("colon", this.props.lang.bowel, "Bowel")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>eye</h3>}><button id="eyesButton" className="eyes"
                                onClick={(button, text, organ) => this.organClicked("eye", this.props.lang.eyes, "Eyes")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>bone</h3>}><button id="boneButton" className="bone"
                                onClick={(button, text, organ) => this.organClicked("bone", this.props.lang.bone, "Bone")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button id="liverButton" className="liver"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "Liver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button id="lungsButton" className="lungs"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lungs, "Lungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button id="pancreasButton" className="pancreas"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "Pancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button id="stomachButton" className="stomach"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "Stomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>breast</h3>}><button className="breast"
                                onClick={(button, text, organ) => this.organClicked("breast/chest", this.props.lang.transbreast, "Breast/Chest")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button id="aortaButton" className="aorta"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "Aorta")}></button></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button id="heartButton" className="heart"
                                onClick={(button, text, oran) => this.organClicked("heart", this.props.lang.heart, "Heart")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button className="genitalia"
                                onClick={(button, text, organ) => this.organClicked("genitalia", this.props.lang.genitalia, "")} /></Tooltip>
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button id="brainButton" className="brain"
                                    onClick={(button, text) => this.iconClicked("brain", this.props.lang.brain)}>
                                    <img src={brainIcon} alt="brainIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physical exam</h3>}><button id="examButton" className="exam"
                                    onClick={(button, text) => this.iconClicked("physical exam", this.props.lang.stethoscope)}>
                                    <img src={examIcon} alt="examIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>hip</h3>}><button id="fallsButton" className="falls"
                                    onClick={(button, text) => this.iconClicked("hip", this.props.lang.hip)}><img
                                        src={fallsIcon} alt="fallsIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>immunization</h3>}><button id="immunizationButton" className="immunization"
                                    onClick={(button, text) => this.iconClicked("needle in arm", this.props.lang.needle_in_arm)}>
                                    <img src={immunizationIcon} alt="immunizationIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>sun</h3>}><button id="sunExposureButton" className="sunExposure"
                                    onClick={(button, text) => this.iconClicked("sun", this.props.lang.sun)}><img
                                        src={sunExposureIcon} alt="sunExposureIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physicalActivity</h3>}><button id="phyActivityButton" className="phyActivity"
                                    onClick={(button, text) => this.iconClicked("figure outside body walking", this.props.lang.figure_outside_body_walking)}>
                                    <img src={phyactIcon} alt="physicalActivityIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>covid</h3>}><button id="covidButton" className="covid"
                                    onClick={(button, text) => this.iconClicked("covid", this.props.lang.covid)}>
                                    <img src={covidIcon} alt="covidIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button id="genitaliaButton" className="transGenital"
                                    onClick={(button, text) => this.iconClicked("genitalia", this.props.lang.genitalia)}>
                                    <img src={transGenital} alt="GenitalT" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Mental Health</h3>}><button id="brainGearButton" className="brainGear"
                                        onClick={(button, text, organ) => this.iconClicked("braingear", this.props.lang.braingear)}>
                                    <img src={braingear} alt="braingear"/></button></Tooltip>
                                ...
                                <button id="sleepButton" className="sleep"
                                        onClick={(button, text, organ) => this.iconClicked("sleep", this.props.lang.sleep)}>
                                    <img src={sleepIcon} alt="sleepIcon"/></button>*/}
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Blood Pressure</h3>}><button id="bpButton" className="bp"
                                        onClick={(button, text, organ) => this.iconClicked("bp", this.props.lang.bp)}>
                                    <img src={bpIcon} alt="bpIcon"/></button></Tooltip>
                                {/*<button id="transButton" className="trans" onClick={(button, text) => this.iconClicked("trans", this.props.lang.covid)}><img src={transIcon} alt="transIcon" /></button>*/}
            ...
            <img id="Uterus" className="organ" src={FemaleUterus} alt="Uterus"/>*/}
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button id="liverButton" className="liver"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "Liver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button id="lungsButton" className="lungs"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lings, "Lungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button id="pancreasButton" className="pancreas"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "Pancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button id="stomachButton" className="stomach"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "Stomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>breast</h3>}><button className="breast"
                                onClick={(button, text, organ) => this.organClicked("breast", this.props.lang.breast, "Breast")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button id="aortaButton" className="aorta"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "Aorta")}></button></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button id="heartButton" className="heart"
                                onClick={(button, text, oran) => this.organClicked("heart", this.props.lang.heart, "Heart")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>uterus</h3>}><button className="uterus"
                                onClick={(button, text, organ) => this.organClicked("uterus", this.props.lang.uterus, "Uterus")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button className="genitalia"
                                onClick={(button, text, organ) => this.organClicked("genitalia", this.props.lang.genitalia, "")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>ovary</h3>}><button className="ovary"
                                onClick={(button, text, organ) => this.organClicked("ovary", this.props.lang.ovary, "")} /></Tooltip>
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button id="brainButton" className="brain"
                                    onClick={(button, text) => this.iconClicked("brain", this.props.lang.brain)}>
                                    <img src={brainIcon} alt="brainIcon" /></button></Tooltip>
                ...
                return (
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>colon</h3>}><button id="bowelButton" className="maleBowel"
                                onClick={(button, text, organ) => this.organClicked("colon", this.props.lang.bowel, "MaleBowel")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>eye</h3>}><button id="eyesButton" className="maleEyes"
                                onClick={(button, text, organ) => this.organClicked("eye", this.props.lang.eyes, "MaleEyes")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>bone</h3>}><button id="boneButton" className="maleBone"
                                onClick={(button, text, organ) => this.organClicked("bone", this.props.lang.bone, "MaleBone")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button id="liverButton" className="maleLiver"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "MaleLiver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button id="lungsButton" className="maleLungs"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lungs, "MaleLungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button id="pancreasButton" className="malePancreas"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "MalePancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button id="stomachButton" className="maleStomach"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "MaleStomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button id="aortaButton" className="maleAorta"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "MaleAorta")}></button></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button id="heartButton" className="maleHeart"
                                onClick={(button, text, organ) => this.organClicked("heart", this.props.lang.heart, "MaleHeart")} /></Tooltip>
                            {/* <button id="genitaliaButton" className="maleGenitalia" onClick={(button, text, organ) => this.organClicked("genitalia", this.props.lang.genitalia, "MaleGenitalia")} /> */}
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button id="brainButton" className="brain"
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physicalActivity</h3>}><button id="phyActivityButton" className="phyActivity"
                                    onClick={(button, text, organ) => this.iconClicked("figure outside body walking", this.props.lang.figure_outside_body_walking)}>
                                    <img src={phyactIcon} alt="physicalActivityIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button id="maleGenitalia" className="maleGenitalia"
                                    onClick={(button, text) => this.iconClicked("genitalia", this.props.lang.genitalia)}>
                                    <img src={MaleGenital} alt="MaleGenitalia" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>covid</h3>}><button id="covidButton" className="covid"
                                    onClick={(button, text, organ) => this.iconClicked("covid", this.props.lang.covid)}>
                ...
                return (
                    <div>
                        <div className="mainRunner">
                            ...
                            <Tooltip title={<h3 style={{ color: "#fff" }}>colon</h3>}><button className="femaleBowel"
                                onClick={(button, text, organ) => this.organClicked("colon", this.props.lang.bowel, "FemaleBowel")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>eye</h3>}><button className="femaleEyes"
                                onClick={(button, text, organ) => this.organClicked("eye", this.props.lang.eyes, "FemaleEyes")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>bone</h3>}><button className="femaleBone"
                                onClick={(button, text, organ) => this.organClicked("bone", this.props.lang.bone, "FemaleBone")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>liver</h3>}><button className="femaleLiver"
                                onClick={(button, text, organ) => this.organClicked("liver", this.props.lang.liver, "FemaleLiver")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>lung</h3>}><button className="femaleLungs"
                                onClick={(button, text, organ) => this.organClicked("lung", this.props.lang.lungs, "FemaleLungs")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>pancreas</h3>}><button className="femalePancreas"
                                onClick={(button, text, organ) => this.organClicked("pancreas", this.props.lang.pancreas, "FemalePancreas")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>stomach</h3>}><button className="femaleStomach"
                                onClick={(button, text, organ) => this.organClicked("stomach", this.props.lang.stomach, "FemaleStomach")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>breast</h3>}><button className="breast"
                                onClick={(button, text, organ) => this.organClicked("breast", this.props.lang.breast, "FemaleBreast")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>aorta</h3>}><button className="femaleAorta"
                                onClick={(button, text, organ) => this.organClicked("aorta", this.props.lang.aorta, "FemaleAorta")}></button></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>heart</h3>}><button className="femaleHeart"
                                onClick={(button, text, organ) => this.organClicked("heart", this.props.lang.heart, "FemaleHeart")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>uterus</h3>}><button className="uterus"
                                onClick={(button, text, organ) => this.organClicked("uterus", this.props.lang.uterus, "FemaleUterus")} /></Tooltip>
                            <Tooltip title={<h3 style={{ color: "#fff" }}>ovary</h3>}><button className="ovary"
                                onClick={(button, text, organ) => this.organClicked("ovary", this.props.lang.ovary, "FemaleOvary")} /></Tooltip>
                            {/* <button id="genitaliaButton" className="femaleGenitalia" onClick={(button, text, organ) => this.organClicked("genitalia", this.props.lang.genitalia, "FemaleGenitalia")} /> */}
                            <div className="icons">
                                <Tooltip title={<h3 style={{ color: "#fff" }}>brain</h3>}><button className="brain"
                                    onClick={(button, text) => this.iconClicked("brain", this.props.lang.brain)}>
                                    <img src={brainIcon} alt="brainIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physical exam</h3>}><button className="exam"
                                    onClick={(button, text) => this.iconClicked("physical exam", this.props.lang.stethoscope)}>
                                    <img src={examIcon} alt="examIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>hip</h3>}><button className="falls"
                                    onClick={(button, text) => this.iconClicked("hip", this.props.lang.hip)}><img
                                        src={fallsIcon} alt="fallsIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>immunization</h3>}><button className="immunization"
                                    onClick={(button, text) => this.iconClicked("needle in arm", this.props.lang.needle_in_arm)}>
                                    <img src={immunizationIcon} alt="immunizationIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>sun</h3>}><button className="sunExposure"
                                    onClick={(button, text) => this.iconClicked("sun", this.props.lang.sun)}><img
                                        src={sunExposureIcon} alt="sunExposureIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>physicalActivity</h3>}><button className="phyActivity"
                                    onClick={(button, text) => this.iconClicked("figure outside body walking", this.props.lang.figure_outside_body_walking)}>
                                    <img src={phyactIcon} alt="physicalActivityIcon" /></button></Tooltip>
                                ...
                                <Tooltip title={<h3 style={{ color: "#fff" }}>covid</h3>}><button id="covidButton" className="covid"
                                    onClick={(button, text) => this.iconClicked("covid", this.props.lang.covid)}>
                                    <img src={covidIcon} alt="covidIcon" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>genitalia</h3>}><button id="femaleGenitalian" className="femaleGenitalia"
                                    onClick={(button, text) => this.iconClicked("genitalia", this.props.lang.genitalia)}>
                                    <img src={FemaleGenital} alt="GenitalF" /></button></Tooltip>
                                <Tooltip title={<h3 style={{ color: "#fff" }}>Mental Health</h3>}><button id="brainGearButton" className="brainGear"
                                        onClick={(button, text, organ) => this.iconClicked("braingear", this.props.lang.braingear)}>
